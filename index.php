  ...
  <main>
    ...
    <section class="mt-50">
      <div class="container mx-auto max-w-7xl text-center flex flex-col gap-2">
        ...
        <div class="flex flex-row gap-4 justify-center">
          <a href="" class="bg-blue-600 text-white text-md py-3 px-6 font-medium rounded-md hover:bg-blue-700">Lihat Artikel</a>
          <a href="" class="border border-blue-600 text-blue-600 text-md py-3 px-6 font-medium rounded-md hover:border-blue-400 hover:text-blue-400">Tentang Kami</a>
        </div>
      </div>
    </section>
    ...
    <section class="container max-w-7xl mx-auto mt-30">
      ...
      <div class="container max-w-7xl mx-auto flex flex-col md:flex-row gap-8 px-8 items-center">
        <img src="https://plus.unsplash.com/premium_vector-1683141200177-9575262876f7?q=80&w=1178&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="tentang_kami"
          class="w-full md:w-full h-80 rounded-md">
        <div class="container max-w-7xl mx-auto flex flex-col md:flex-col gap-12">
